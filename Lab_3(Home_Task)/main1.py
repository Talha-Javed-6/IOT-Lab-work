...
# Setup button for interrupt (connected to GPIO 12)
...
# Define Interrupt Service Routine (ISR) for button
def button_isr(pin):
    update_display()  # Update display immediately on button press
    

# Attach interrupt to button (trigger on falling edge, i.e., when pressed)
